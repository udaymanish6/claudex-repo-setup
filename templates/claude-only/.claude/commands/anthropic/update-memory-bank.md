Recover or update the project memory bank from the current project state. This command is the fallback/ongoing updater; first-time generation is expected during `/init`.
