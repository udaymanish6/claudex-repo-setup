...
description: Execute the system-local date command and return ONLY the raw output. No formatting, headers, explanations, or parallel agents.
...
Example response: `Tue Jun 16 14:30:00 EDT 2026`
